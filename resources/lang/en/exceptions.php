...
return [
   ...
   */
   ...
   'backend' => [
      'management'   => [
         'leads'  => [
            'create_error'       => 'There was a problem creating this lead. Please try again.',
            'update_error'       => 'There was a problem updating this lead. Please try again.',
            'delete_error'       => 'There was a problem deleting this lead. Please try again.',
            'delete_first'       => 'This lead must be deleted first before it can be destroyed permanently.',
            'cant_restore'       => 'This lead is not deleted so it can not be restored.',
