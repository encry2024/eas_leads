...
return [
   ...
   */
   ...
   'backend' => [
      'management'   => [
         'lead'   => [
            'delete_lead_confirm'   => 'Are you sure you want to delete this lead permanently? Anywhere in the application that references this lead\'s id will most likely error. Proceed at your own risk. This can not be un-done.',
            'restore_lead_confirm'  => 'Restore this lead to its original state?'
         ]
      ],
